...
class AssignmentService {
    ...
    def deleteAssignment(Assignment assignment, User user, boolean flush = true) {
        ...
        PeerGrading.executeUpdate("delete PeerGrading pg where pg.openResponse in (from OpenInteractionResponse resp where resp.interaction in (from Interaction i where i.sequence in (from Sequence s where s.assignment = ?)))",[assignment])
        ...
        OpenInteractionResponse.executeUpdate("delete OpenInteractionResponse resp where resp.interaction in (from Interaction i where i.sequence in (from Sequence s where s.assignment = ?))",[assignment])
