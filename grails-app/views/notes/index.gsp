                ...
                <g:if test="${fragmentTag}">
                    <span class="badge"
                          id="button_fragment_tag">#${fragmentTag.name} <g:link controller="notes"
                                                                                params='[contextId: "${params.contextId}", displaysMyNotes: "${params.displaysMyNotes}", displaysMyFavorites: "${params.displaysMyFavorites}", displaysAll: "${params.displaysAll}", inline: "${params.inline}"]'><span
