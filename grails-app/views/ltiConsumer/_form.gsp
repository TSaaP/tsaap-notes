...
<div class="form-group fieldcontain ${hasErrors(bean: ltiConsumerInstance, field: 'id', 'error')} ">
	<label for="id">
...
<div class="form-group fieldcontain ${hasErrors(bean: ltiConsumerInstance, field: 'consumerName', 'error')} ">
...
<div class="form-group fieldcontain ${hasErrors(bean: ltiConsumerInstance, field: 'secret', 'error')} ">
	<label for="secret">
...
<div class="form-group fieldcontain ${hasErrors(bean: ltiConsumerInstance, field: 'ltiVersion', 'error')} ">
...
<div class="form-group fieldcontain ${hasErrors(bean: ltiConsumerInstance, field: 'productName', 'error')} ">
...
<div class="form-group fieldcontain ${hasErrors(bean: ltiConsumerInstance, field: 'productVersion', 'error')} ">
...
<div class="form-group fieldcontain ${hasErrors(bean: ltiConsumerInstance, field: 'productGuid', 'error')} ">
...
<div class="form-group fieldcontain ${hasErrors(bean: ltiConsumerInstance, field: 'cssPath', 'error')} ">
	<label for="cssPath">
...
<div class="form-group fieldcontain ${hasErrors(bean: ltiConsumerInstance, field: 'isProtected', 'error')} required">
	<label for="isProtected">
		<g:message code="ltiConsumer.isProtected.label" default="Is Protected" />
		<span class="required-indicator">*</span>
	</label>
	<g:field name="isProtected" type="number" value="${ltiConsumerInstance.isProtected}" required="" class="form-control"/>
</div>

<div class="form-group fieldcontain ${hasErrors(bean: ltiConsumerInstance, field: 'isEnabled', 'error')} required">
	<label for="isEnabled">
...
<div class="form-group fieldcontain ${hasErrors(bean: ltiConsumerInstance, field: 'enableFrom', 'error')} ">
	<label for="enableFrom">
		<g:message code="ltiConsumer.enableFrom.label" default="Enable From" />
		
	</label>
	<g:datePicker name="enableFrom" precision="day"  value="${ltiConsumerInstance?.enableFrom}" default="none" noSelection="['': '']"  class="form-control"/>
</div>

<div class="form-group fieldcontain ${hasErrors(bean: ltiConsumerInstance, field: 'enableUntil', 'error')} ">
	<label for="enableUntil">
		<g:message code="ltiConsumer.enableUntil.label" default="Enable Until" />
		
	</label>
	<g:datePicker name="enableUntil" precision="day"  value="${ltiConsumerInstance?.enableUntil}" default="none" noSelection="['': '']"  class="form-control"/>
</div>

<div class="form-group fieldcontain ${hasErrors(bean: ltiConsumerInstance, field: 'lastAccess', 'error')} required">
