...
class ActivationKeyServiceSpec extends Specification {
    ...
    def setup() {
        ...
        user3 = new User(firstName: "moghite3", lastName: "kacimi", username: "akac3", enabled: true,password: "password", email: "akac3@nomail.com", language: 'fr').save()
    ...
    void "test removeOldActivationKeys"() {
        ...
        then:"Count number of ActivationKey ans number of user"
        ActivationKey.count() == 1
        User.count() == 4
        ...
        activationKey3.save()
        activationKey3.dateCreated = DateUtils.addHours(new Date(), -5)
        activationKey3.save()
