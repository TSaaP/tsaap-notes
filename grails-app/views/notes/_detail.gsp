    ...
    <small>
      ...
      <g:if test="${note.hasParent() && !noteClassParent && showDiscussionNote}">
        <g:link controller="notes" action="hideDiscussion"
                params="${[contextId: params.contextId, fragmentTagId: note.fragmentTagId] + displayListParamsWithPagination}"
                fragment="note${note.id}">
      ...
      <g:if test="${user == note.author}">
        <g:link controller="notes" action="deleteNote"
                params="${[noteId: note.id, contextId: params.contextId, fragmentTagId: note.fragmentTagId] + displayListParamsWithPagination}"><span
