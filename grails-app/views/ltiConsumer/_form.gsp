...
<div class="form-group fieldcontain ${hasErrors(bean: ltiConsumerInstance, field: 'isProtected', 'error')} required">
    ...
    <g:field name="isProtected" type="number" value="${ltiConsumerInstance.isProtected}" required=""
             class="form-control"/>
</div>
...
<div class="form-group fieldcontain ${hasErrors(bean: ltiConsumerInstance, field: 'enableFrom', 'error')} ">
    ...
    <g:datePicker name="enableFrom" precision="day" value="${ltiConsumerInstance?.enableFrom}" default="none"
