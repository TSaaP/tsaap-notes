...
<div class="btn-group btn-group-sm" role="group">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
        <g:if test="${sequenceInstance != sequenceInstanceList[0]}">
            <li><g:link action="upSequence" id="${sequenceInstance.id}" controller="assignment">
                <g:message code="sequence.action.upSequence.label"/></g:link></li>
        </g:if>
        <g:if test="${sequenceInstance != sequenceInstanceList.last()}">
            <li><g:link action="downSequence" id="${sequenceInstance.id}" controller="assignment">
                <g:message code="sequence.action.downSequence.label"/></g:link></li>
        </g:if>
        <li role="separator" class="divider"></li>
        <li><g:link action="deleteSequence" controller="assignment" id="${sequenceInstance.id}"
