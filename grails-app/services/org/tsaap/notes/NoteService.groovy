...
class NoteService {
    ...
    @Transactional
    @Requires({
        author && content && (!context || context.isOpen()) && (noteKind == NoteKind.EXPLANATION || parentNote?.noteKind != NoteKind.QUESTION) && (noteKind != NoteKind.QUESTION || author == context.owner)
    })
