...
<p>
<g:if test="${responseInteraction.interactionSpecification.hasChoices()}">
...
<g:remoteLink class="btn-group btn-success" controller="player" action="stopInteraction" id="${interactionInstance.id}"
