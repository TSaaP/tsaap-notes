...
class ResponseNotificationService {
    ...
    Map findAllResponsesNotifications() {
        ...
        def req = """
                SELECT distinct tnote1.author_id as question_author, tuser1.first_name, tuser1.email, tuser1.language, tcontext.id as context_id, tcontext.context_name,
                ...
                WHERE  tnote2.date_created > date_sub(now(),interval 60 minute)
                ...
                and (tnote1.fragment_tag_id is null or ttag.id = tnote1.fragment_tag_id)
